...
function Page1() {
  ...
  const Procedure = () => {
    useEffect(() => {
      ...
      drawLine(context, 0 + 30, 50, 0 - 30, 50, 'rgb(20, 65, 132)');
  ...
  return (
    ...
    <div className="body">
      <div className="container">
        ...
        <ul>
            <h3><li><strong>FRIEND 어플은 대학교 내에서 만남을 즐길 수 있는 어플입니다.</strong></li></h3>
      ...
      <div className="body">
        <div className="container">
          <div className="ConsentForm2">
            <h2>개인정보 활용 동의서</h2>
            <p>안녕하세요, '프렌즈 어플'을 이용해 주셔서 감사합니다. 본 어플리케이션은 회원님의 개인정보를 안전하게 관리하고 활용하기 위해 다음과 같은 내용으로 개인정보를 수집 및 이용합니다.</p>
